    ...
    return (
        ...
        >
            ...
            sx={{height:'100%'}}>
                    ...
                    <CardContent>
                        <Typography variant="body2">
                        <b>Вова</b> и <b>Валя</b> обнаружили, что у них совершенно разные планы на жизнь, когда играли на тему <b>"О будущем"</b>.<br/><br/> Один из них был более амбициозным, в то время как другой был склонен к более скромным планам на будущее.<br/><br/> Общение и обсуждение своих взглядов помогли им найти компромисс, который устроил обоих. Теперь у них есть общее видение будущего.
                        </Typography>
                    </CardContent>
                </Card>
            </Grid>
